...
exports.connect = function(socket, data, cb) {
  ...
  socket.on('servers:read', function(data, callback) {
    query(buffers, 'gui_buffers(*)', function(buffers) {

      var servers = buffers.map(function(buffer) {
        return getBuffer(buffer);
      }).filter(function(buffer) {
        return buffer.type === 'server';
      });
  ...
  socket.on('buffers:read', function(data, callback) {
    query(buffers, 'gui_buffers(*)', function(buffers) {
